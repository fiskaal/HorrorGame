...
namespace DizzyMedia.HFPS_Components {
    ...
    [CustomEditor(typeof(HFPS_ScreenEvents))]
    public class HFPS_ScreenEventsEditor : Editor {
    ...
    //////////////////////////
        ...
        private void OnEnable() {
            ...
            scrEvents = (HFPS_ScreenEvents)target;
        ...
        public override void OnInspectorGUI() {
            ...
            GUILayout.BeginHorizontal("Screen Events", "HeaderText");
            ...
            scrEvents.tabs = GUILayout.SelectionGrid(scrEvents.tabs, new string[] { "User Options", "Auto/Debug"}, 2);
            ...
            if(scrEvents.tabs == 1){
                ...
                scrEvents.curCategory = EditorGUILayout.IntField("Current Category", scrEvents.curCategory);
                scrEvents.curEvent = EditorGUILayout.IntField("Current Event", scrEvents.curEvent);
            ...
            if(GUI.changed){
                ...
                EditorUtility.SetDirty(scrEvents);
